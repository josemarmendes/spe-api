...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.pulse.spe.api.controller"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().contact(new Contact("Josemar Mendes", "", ""))
